...
def get_data_covid():
    data_covid = {}
    path_excel = '/tmp/CASOS_19012021.csv'
    url = 'https://podcast-henry.s3.amazonaws.com/CASOS_19012021.csv'
    ...
    with open(path_excel, newline='') as csvfile:
        ...
        for row in spamreader:
            ...
            data_covid[depa] = {
                'PCR': pcr,
                'PRUEBA RAPIDA': prueba_quick,
                'PRUEBA ANTIGENO': prueba_antigeno,
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "bienvenido a mi app de estadisticas covid"
...
class EstadisticasdIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "estos son mis datos para " + departamento +  filter2
